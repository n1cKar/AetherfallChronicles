...
export const BIOME_DEFINITIONS: Record<BiomeId, BiomeDefinition> = {
  forest: {
    ...
    treeDensity: 0.35,
    rockDensity: 0.08,
    enemyTypes: ['goblin', 'grove_wisp', 'thorn_stalker', 'wild_boar'],
    ambientCreatures: ['butterfly', 'deer'],
    musicMood: 'peaceful',
  },
  swamp: {
    id: 'swamp',
    name: 'Gloomroot Caves',
    ...
    treeDensity: 0.2,
    rockDensity: 0.05,
    enemyTypes: ['zombie', 'spider', 'bog_shade', 'leech_lord'],
    ambientCreatures: ['firefly'],
    musicMood: 'eerie',
  },
  frozen: {
    id: 'frozen',
    name: 'Iceglass Caverns',
    ...
    treeDensity: 0.12,
    rockDensity: 0.15,
    enemyTypes: ['skeleton', 'ice_wraith', 'frost_dragon', 'frost_titan'],
    ambientCreatures: ['snow_owl'],
    musicMood: 'cold',
  },
  mountain: {
    id: 'mountain',
    name: 'Highcastle Cliffs',
    ...
    treeDensity: 0.08,
    rockDensity: 0.35,
    enemyTypes: ['skeleton', 'mage', 'stone_golem', 'harpy'],
    ambientCreatures: ['eagle'],
    musicMood: 'epic',
  },
  volcanic: {
    id: 'volcanic',
    name: 'Molten Forge Lava Zone',
    ...
    treeDensity: 0.02,
    rockDensity: 0.25,
    enemyTypes: ['magma_spawn', 'ash_demon', 'ember_dragon'],
    ambientCreatures: [],
    musicMood: 'intense',
  },
  desert: {
    ...
    treeDensity: 0.03,
    rockDensity: 0.12,
    enemyTypes: ['skeleton', 'sand_phantom', 'scorpion_king'],
    ambientCreatures: ['lizard'],
    musicMood: 'mystic',
  },
  hell: {
    id: 'hell',
    name: 'Infernal Castle Depths',
    ...
    treeDensity: 0,
    rockDensity: 0.2,
    enemyTypes: ['infernal_knight', 'pit_horror', 'dragon_lord'],
    ambientCreatures: [],
    musicMood: 'boss',
  },
  magical: {
    id: 'magical',
    name: 'Runelight Ruins',
    ...
    treeDensity: 0.15,
    rockDensity: 0.1,
    enemyTypes: ['mage', 'arcane_sentinel', 'mana_leech', 'dungeon_golem'],
    ambientCreatures: ['spirit_wisp'],
    musicMood: 'magical',
  },
  corrupted: {
    id: 'corrupted',
    name: 'Blighted Dungeon Expanse',
    ...
    treeDensity: 0.05,
    rockDensity: 0.18,
    enemyTypes: ['zombie', 'skeleton', 'void_abomination', 'corrupted_titan'],
    ambientCreatures: [],
    musicMood: 'dark',
  },
};
